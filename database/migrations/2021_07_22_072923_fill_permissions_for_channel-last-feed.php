...
class FillPermissionsForChannelLastFeed extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForChannelLastFeed constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.channel-last-feed',
            'admin.channel-last-feed.index',
            'admin.channel-last-feed.create',
            'admin.channel-last-feed.show',
            'admin.channel-last-feed.edit',
            'admin.channel-last-feed.delete',
            'admin.channel-last-feed.bulk-delete',
        ]);

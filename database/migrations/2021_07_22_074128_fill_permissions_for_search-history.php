...
class FillPermissionsForSearchHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSearchHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.search-history.index',
            'admin.search-history.create',
            'admin.search-history.show',
            'admin.search-history.edit',
            'admin.search-history.delete',
            'admin.search-history.bulk-delete',
        ]);

...
class FillPermissionsForSearcgHistory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSearcgHistory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.searcg-history',
            'admin.searcg-history.index',
            'admin.searcg-history.create',
            'admin.searcg-history.show',
            'admin.searcg-history.edit',
            'admin.searcg-history.delete',
            'admin.searcg-history.bulk-delete',
        ]);
